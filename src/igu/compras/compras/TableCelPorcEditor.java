 ...
 * @author Asullom
 */
public class TableCelPorcEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public TableCelPorcEditor(ComprasPanel compra) {
        this.compra = compra;
        ...
        valor.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (!valorActual.trim().isEmpty()) {
                    ...
                    System.out.println("getPorc : " + d.getPorc());
                    ...
                    if (d.getMov_tipo() == 1) {
                        ...
                        d.setOnza(d.getOnza());
                        d.setPorc(Double.parseDouble(valorActual + ""));
                        d.setLey(d.getLey());
                    ...
                    MsgPanel.error("% es requerido", true);
                }
            }
        });
    }
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        System.out.println("getTableCellEditorComponent  % fila: " + row);
        tabla = table;
        fila = row;
        col = column;
