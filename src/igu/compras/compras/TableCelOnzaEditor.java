 ...
 * @author Asullom
 */
public class TableCelOnzaEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public TableCelOnzaEditor(ComprasPanel compra) {
        this.compra = compra;
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (!valorActual.trim().isEmpty()) {
                    ...
                    if (d.getMov_tipo() == 1) {
                        ...
                        d.setOnza(Double.parseDouble(valorActual + ""));
                        d.setPorc(d.getPorc());
                        d.setLey(d.getLey());
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        System.out.println("getTableCellEditorComponent  onza fila: " + row);
        tabla = table;
        fila = row;
        col = column;
